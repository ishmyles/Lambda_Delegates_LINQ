...
namespace FileParserNetStandard_Tests
{
    ...
    public class Tests
    {
        ...
        private string _csvPath = "/Users/ishmyles/Desktop/Dip-Seminar-Delegates-Lambda-Linq_Exercises-master/data.csv";  // change to appropriate path
        private string _tsvPath = "/Users/ishmyles/Desktop/Dip-Seminar-Delegates-Lambda-Linq_Exercises-master/data.tsv";  // change to appropriate path

        private string _writeFile = "/Users/ishmyles/Desktop/Dip-Seminar-Delegates-Lambda-Linq_Exercises-master/dataWrite.txt";  // change to appropriate path
